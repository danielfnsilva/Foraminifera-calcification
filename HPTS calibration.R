# README
# This script was originally made for the publication "Open or closed: pH modulation and calcification by foraminifera".
# It performs data normalization and fits a Boltzmann model to pH-dependent 
# ratio data. The analysis includes 
# reading data from an Excel file, normalizing the ratio values, fitting the models (4PL and 
# Boltzmann), and visualizing the results with a plot showing the data points and the fitted 
# Boltzmann curve.
# 
# For detailed methodology, check the articles: 
# https://doi.org/10.4319/lom.2008.6.610 and https://doi.org/10.1038/ncomms14145.
...
data <- read_excel("Bulk data.xlsx")
head(data)
